<template>
    <footer class=" bg-red-900">
        <div class="container px-6 py-12 mx-auto">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                <div class="sm:col-span-2">
                    <h1 class="max-w-lg text-xl font-semibold tracking-tight
                     text-red-800 xl:text-2xl text-white">
            ...
            <hr class="my-6 border-red-200 md:my-8 border-red-700">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex -mx-2">
                    <a href="#"
                        class="mx-2 text-white-600 transition-colors duration-300 text-white-300 hover:text-white-500 hover:text-white-400"
                        aria-label="Twitter">
