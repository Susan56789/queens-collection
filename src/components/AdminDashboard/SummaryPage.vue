<template>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
        ...
        <!-- Social Traffic -->
        <div
            class="relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 bg-gray-800 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
                <div class="flex flex-wrap items-center px-4 py-2">
                    ...
                    <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                        <button
                            class=" dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        ...
        <!-- Recent Activities -->
        <div class="relative flex flex-col min-w-0 break-words bg-gray-50 bg-gray-800 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
                <div class="flex flex-wrap items-center px-4 py-2">
                    <div class="relative w-full max-w-full flex-grow flex-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-black dark:text-white">
        ...
        <div class="md:col-span-2 xl:col-span-1">
            <div class="rounded bg-gray-200 bg-gray-800 p-3">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 bg-gray-800">
                        <tr
